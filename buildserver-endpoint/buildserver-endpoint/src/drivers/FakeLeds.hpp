 ...
 */
class FakeLeds final : public ILeds, public IInitable
{
public:
    /**
     * \brief   Constructor.
    ...
    /**
     * \brief   Indicate if fake leds are initialized.
     * \returns True if fake leds are initialized, else false.
     */
    bool IsInit() const override { return mInitialized; }

    /**
     * \brief   Puts the fake leds module in sleep mode.
     * \returns Always true since there is no hardware.
     */
