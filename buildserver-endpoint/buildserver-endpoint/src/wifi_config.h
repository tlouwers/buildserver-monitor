 ...
 *                                                                Terry Louwers
 *
 * \brief   WiFi configuration file for the Buildserver Endpoint.
 *
...
#ifndef BUILDSERVER_ENDPOINT_WIFI_CONFIG_H_
#define BUILDSERVER_ENDPOINT_WIFI_CONFIG_H_
...
#endif  // BUILDSERVER_ENDPOINT_WIFI_CONFIG_H_
